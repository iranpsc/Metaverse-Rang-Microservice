...
type GetVideoRequest struct {
	...
	IpAddress     string                 `protobuf:"bytes,3,opt,name=ip_address,json=ipAddress,proto3" json:"ip_address,omitempty"` // optional for view tracking
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetVideoRequest) GetIpAddress() string {
	if x != nil {
		return x.IpAddress
	}
	return ""
...
type GetVideoByFileNameRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FileName      string                 `protobuf:"bytes,1,opt,name=file_name,json=fileName,proto3" json:"file_name,omitempty"`    // partial file name to match
	IpAddress     string                 `protobuf:"bytes,2,opt,name=ip_address,json=ipAddress,proto3" json:"ip_address,omitempty"` // optional for view tracking
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetVideoByFileNameRequest) Reset() {
	*x = GetVideoByFileNameRequest{}
	mi := &file_training_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetVideoByFileNameRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetVideoByFileNameRequest) ProtoMessage() {}

func (x *GetVideoByFileNameRequest) ProtoReflect() protoreflect.Message {
	mi := &file_training_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetVideoByFileNameRequest.ProtoReflect.Descriptor instead.
func (*GetVideoByFileNameRequest) Descriptor() ([]byte, []int) {
	return file_training_proto_rawDescGZIP(), []int{2}
}

func (x *GetVideoByFileNameRequest) GetFileName() string {
	if x != nil {
		return x.FileName
	}
	return ""
...
func (x *GetVideoByFileNameRequest) GetIpAddress() string {
	if x != nil {
		return x.IpAddress
	}
	return ""
...
const file_training_proto_rawDesc = "" +
	...
	"\x19GetVideoByFileNameRequest\x12\x1b\n" +
	"\tfile_name\x18\x01 \x01(\tR\bfileName\x12\x1d\n" +
	"\n" +
	"ip_address\x18\x02 \x01(\tR\tipAddress\"f\n" +
...
var file_training_proto_goTypes = []any{
	...
	(*GetVideoByFileNameRequest)(nil),    // 2: training.GetVideoByFileNameRequest
	(*SearchVideosRequest)(nil),          // 3: training.SearchVideosRequest
	(*VideoResponse)(nil),                // 4: training.VideoResponse
	(*VideosResponse)(nil),               // 5: training.VideosResponse
