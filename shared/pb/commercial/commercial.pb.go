...
type ProcessReferralRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	BuyerUserId   uint64                 `protobuf:"varint,1,opt,name=buyer_user_id,json=buyerUserId,proto3" json:"buyer_user_id,omitempty"` // user who placed the order
	OrderId       uint64                 `protobuf:"varint,2,opt,name=order_id,json=orderId,proto3" json:"order_id,omitempty"`
	Asset         string                 `protobuf:"bytes,3,opt,name=asset,proto3" json:"asset,omitempty"`
	Amount        float64                `protobuf:"fixed64,4,opt,name=amount,proto3" json:"amount,omitempty"` // order amount in asset units (same as orders.amount)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_commercial_proto_rawDesc = "" +
	...
	"\rVerifyPayment\x12 .commercial.VerifyPaymentRequest\x1a!.commercial.VerifyPaymentResponse2`\n" +
...
var file_commercial_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_commercial_proto_goTypes = []any{
	...
	(*ProcessReferralRequest)(nil),      // 24: commercial.ProcessReferralRequest
	(*timestamppb.Timestamp)(nil),       // 25: google.protobuf.Timestamp
	(*emptypb.Empty)(nil),               // 26: google.protobuf.Empty
}
var file_commercial_proto_depIdxs = []int32{
	25, // 0: commercial.Wallet.created_at:type_name -> google.protobuf.Timestamp
	25, // 1: commercial.Wallet.updated_at:type_name -> google.protobuf.Timestamp
	25, // 2: commercial.Transaction.created_at:type_name -> google.protobuf.Timestamp
	25, // 3: commercial.Transaction.updated_at:type_name -> google.protobuf.Timestamp
	25, // 4: commercial.Order.created_at:type_name -> google.protobuf.Timestamp
	25, // 5: commercial.Payment.created_at:type_name -> google.protobuf.Timestamp
	...
	24, // 23: commercial.ReferralService.ProcessReferral:input_type -> commercial.ProcessReferralRequest
	5,  // 24: commercial.WalletService.GetWallet:output_type -> commercial.WalletResponse
	7,  // 25: commercial.WalletService.DeductBalance:output_type -> commercial.DeductBalanceResponse
	9,  // 26: commercial.WalletService.AddBalance:output_type -> commercial.AddBalanceResponse
	26, // 27: commercial.WalletService.LockBalance:output_type -> google.protobuf.Empty
	26, // 28: commercial.WalletService.UnlockBalance:output_type -> google.protobuf.Empty
	13, // 29: commercial.TransactionService.ListTransactions:output_type -> commercial.ListTransactionsResponse
	16, // 30: commercial.TransactionService.GetLatestTransaction:output_type -> commercial.LatestTransactionResponse
	1,  // 31: commercial.TransactionService.CreateTransaction:output_type -> commercial.Transaction
	19, // 32: commercial.PaymentService.InitiatePayment:output_type -> commercial.InitiatePaymentResponse
	21, // 33: commercial.PaymentService.HandleCallback:output_type -> commercial.HandleCallbackResponse
	23, // 34: commercial.PaymentService.VerifyPayment:output_type -> commercial.VerifyPaymentResponse
	26, // 35: commercial.ReferralService.ProcessReferral:output_type -> google.protobuf.Empty
