...
func (UnimplementedWalletConnectionServiceServer) GetLinkNonce(context.Context, *GetWalletLinkNonceRequest) (*GetWalletNonceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetLinkNonce not implemented")
}
...
func (UnimplementedWalletConnectionServiceServer) GetSecurityNonce(context.Context, *GetWalletSecurityNonceRequest) (*GetWalletNonceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetSecurityNonce not implemented")
}
func (UnimplementedWalletConnectionServiceServer) VerifySecuritySignature(context.Context, *VerifyWalletSecuritySignatureRequest) (*VerifyWalletSecuritySignatureResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method VerifySecuritySignature not implemented")
}
...
func RegisterWalletConnectionServiceServer(s grpc.ServiceRegistrar, srv WalletConnectionServiceServer) {
	// If the following call panics, it indicates UnimplementedWalletConnectionServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
