...
type TicketResponse struct {
	...
	Messages      []*TicketResponseItem  `protobuf:"bytes,14,rep,name=messages,proto3" json:"messages,omitempty"`                                   // chat thread: opening + replies, oldest first
	CurrentUserId uint64                 `protobuf:"varint,15,opt,name=current_user_id,json=currentUserId,proto3" json:"current_user_id,omitempty"` // viewer used to compute is_mine
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TicketResponse) GetMessages() []*TicketResponseItem {
	if x != nil {
		return x.Messages
	}
	return nil
...
func (x *TicketResponse) GetCurrentUserId() uint64 {
	if x != nil {
...
type TicketResponseItem struct {
	...
	Author        *common.UserBasic      `protobuf:"bytes,8,opt,name=author,proto3" json:"author,omitempty"`
	Role          string                 `protobuf:"bytes,9,opt,name=role,proto3" json:"role,omitempty"`                     // sender, receiver, staff
	IsMine        bool                   `protobuf:"varint,10,opt,name=is_mine,json=isMine,proto3" json:"is_mine,omitempty"` // relative to current_user_id
	Kind          string                 `protobuf:"bytes,11,opt,name=kind,proto3" json:"kind,omitempty"`                    // opening, reply
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TicketResponseItem) GetAuthor() *common.UserBasic {
	if x != nil {
		return x.Author
	}
	return nil
...
func (x *TicketResponseItem) GetRole() string {
	if x != nil {
		return x.Role
	}
	return ""
...
func (x *TicketResponseItem) GetIsMine() bool {
	if x != nil {
		return x.IsMine
	}
	return false
...
func (x *TicketResponseItem) GetKind() string {
	if x != nil {
		return x.Kind
	}
	return ""
...
type CreateReportRequest struct {
	...
	ImagePaths     []string               `protobuf:"bytes,7,rep,name=image_paths,json=imagePaths,proto3" json:"image_paths,omitempty"` // relative storage paths, e.g. reports/file.png
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *CreateReportRequest) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *CreateReportRequest) GetImagePaths() []string {
	if x != nil {
		return x.ImagePaths
	}
	return nil
...
type ReportResponse struct {
	...
	ImagePaths     []string               `protobuf:"bytes,9,rep,name=image_paths,json=imagePaths,proto3" json:"image_paths,omitempty"` // relative storage paths
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *ReportResponse) GetImagePaths() []string {
	if x != nil {
		return x.ImagePaths
	}
	return nil
...
const file_support_proto_rawDesc = "" +
	...
	"\tticket_id\x18\x01 \x01(\x04R\bticketId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\x04R\x06userId\"\x90\x04\n" +
	...
	"\n" +
	"updated_at\x18\r \x01(\tR\tupdatedAt\x127\n" +
	"\bmessages\x18\x0e \x03(\v2\x1b.support.TicketResponseItemR\bmessages\x12&\n" +
	"\x0fcurrent_user_id\x18\x0f \x01(\x04R\rcurrentUserId\"|\n" +
	...
	"\x06author\x18\b \x01(\v2\x11.common.UserBasicR\x06author\x12\x12\n" +
	"\x04role\x18\t \x01(\tR\x04role\x12\x17\n" +
	"\ais_mine\x18\n" +
	" \x01(\bR\x06isMine\x12\x12\n" +
	"\x04kind\x18\v \x01(\tR\x04kind\"\xe9\x01\n" +
	...
	"\n" +
	"DeleteNote\x12\x1a.support.DeleteNoteRequest\x1a\r.common.EmptyB\x1cZ\x1ametarang/shared/pb/supportb\x06proto3"
...
var file_support_proto_depIdxs = []int32{
	...
	8,  // 4: support.TicketResponse.messages:type_name -> support.TicketResponseItem
	6,  // 5: support.TicketsResponse.tickets:type_name -> support.TicketResponse
	35, // 6: support.TicketsResponse.pagination:type_name -> common.PaginationMeta
	34, // 7: support.TicketResponseItem.author:type_name -> common.UserBasic
	33, // 8: support.GetReportsRequest.pagination:type_name -> common.PaginationRequest
	12, // 9: support.ReportsResponse.reports:type_name -> support.ReportResponse
	35, // 10: support.ReportsResponse.pagination:type_name -> common.PaginationMeta
	33, // 11: support.GetUserEventsRequest.pagination:type_name -> common.PaginationRequest
	17, // 12: support.UserEventReportDetail.responses:type_name -> support.UserEventReportResponseItem
	18, // 13: support.UserEventResponse.report:type_name -> support.UserEventReportDetail
	19, // 14: support.UserEventsResponse.events:type_name -> support.UserEventResponse
	35, // 15: support.UserEventsResponse.pagination:type_name -> common.PaginationMeta
	31, // 16: support.NotesResponse.notes:type_name -> support.NoteResponse
	0,  // 17: support.TicketService.CreateTicket:input_type -> support.CreateTicketRequest
	4,  // 18: support.TicketService.GetTickets:input_type -> support.GetTicketsRequest
	5,  // 19: support.TicketService.GetTicket:input_type -> support.GetTicketRequest
	1,  // 20: support.TicketService.UpdateTicket:input_type -> support.UpdateTicketRequest
	2,  // 21: support.TicketService.AddResponse:input_type -> support.AddResponseRequest
	3,  // 22: support.TicketService.CloseTicket:input_type -> support.CloseTicketRequest
	9,  // 23: support.ReportService.CreateReport:input_type -> support.CreateReportRequest
	10, // 24: support.ReportService.GetReports:input_type -> support.GetReportsRequest
	11, // 25: support.ReportService.GetReport:input_type -> support.GetReportRequest
	14, // 26: support.UserEventReportService.CreateUserEvent:input_type -> support.CreateUserEventRequest
	15, // 27: support.UserEventReportService.GetUserEvents:input_type -> support.GetUserEventsRequest
	16, // 28: support.UserEventReportService.GetUserEvent:input_type -> support.GetUserEventRequest
	21, // 29: support.UserEventReportService.ReportUserEvent:input_type -> support.ReportUserEventRequest
	23, // 30: support.UserEventReportService.SendEventReportResponse:input_type -> support.SendEventReportResponseRequest
	25, // 31: support.UserEventReportService.CloseUserEventReport:input_type -> support.CloseUserEventReportRequest
	26, // 32: support.NoteService.CreateNote:input_type -> support.CreateNoteRequest
	28, // 33: support.NoteService.GetNotes:input_type -> support.GetNotesRequest
	29, // 34: support.NoteService.GetNote:input_type -> support.GetNoteRequest
	27, // 35: support.NoteService.UpdateNote:input_type -> support.UpdateNoteRequest
	30, // 36: support.NoteService.DeleteNote:input_type -> support.DeleteNoteRequest
	6,  // 37: support.TicketService.CreateTicket:output_type -> support.TicketResponse
	7,  // 38: support.TicketService.GetTickets:output_type -> support.TicketsResponse
	6,  // 39: support.TicketService.GetTicket:output_type -> support.TicketResponse
	6,  // 40: support.TicketService.UpdateTicket:output_type -> support.TicketResponse
	6,  // 41: support.TicketService.AddResponse:output_type -> support.TicketResponse
	6,  // 42: support.TicketService.CloseTicket:output_type -> support.TicketResponse
	12, // 43: support.ReportService.CreateReport:output_type -> support.ReportResponse
	13, // 44: support.ReportService.GetReports:output_type -> support.ReportsResponse
	12, // 45: support.ReportService.GetReport:output_type -> support.ReportResponse
	19, // 46: support.UserEventReportService.CreateUserEvent:output_type -> support.UserEventResponse
	20, // 47: support.UserEventReportService.GetUserEvents:output_type -> support.UserEventsResponse
	19, // 48: support.UserEventReportService.GetUserEvent:output_type -> support.UserEventResponse
	22, // 49: support.UserEventReportService.ReportUserEvent:output_type -> support.UserEventReportResponse
	24, // 50: support.UserEventReportService.SendEventReportResponse:output_type -> support.SendEventReportResponseReply
	36, // 51: support.UserEventReportService.CloseUserEventReport:output_type -> common.Empty
	31, // 52: support.NoteService.CreateNote:output_type -> support.NoteResponse
	32, // 53: support.NoteService.GetNotes:output_type -> support.NotesResponse
	31, // 54: support.NoteService.GetNote:output_type -> support.NoteResponse
	31, // 55: support.NoteService.UpdateNote:output_type -> support.NoteResponse
	36, // 56: support.NoteService.DeleteNote:output_type -> common.Empty
