...
func (c *featureServiceClient) UpdateMyFeature(ctx context.Context, in *UpdateMyFeatureRequest, opts ...grpc.CallOption) (*UpdateMyFeatureResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateMyFeatureResponse)
...
func (UnimplementedFeatureServiceServer) UpdateMyFeature(context.Context, *UpdateMyFeatureRequest) (*UpdateMyFeatureResponse, error) {
...
const (
	...
	FeatureMarketplaceService_ListFeatureSellRequests_FullMethodName = "/features.FeatureMarketplaceService/ListFeatureSellRequests"
...
type FeatureMarketplaceServiceClient interface {
	...
	ListFeatureSellRequests(ctx context.Context, in *ListFeatureSellRequestsRequest, opts ...grpc.CallOption) (*SellRequestsResponse, error)
...
func (c *featureMarketplaceServiceClient) ListFeatureSellRequests(ctx context.Context, in *ListFeatureSellRequestsRequest, opts ...grpc.CallOption) (*SellRequestsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SellRequestsResponse)
	err := c.cc.Invoke(ctx, FeatureMarketplaceService_ListFeatureSellRequests_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FeatureMarketplaceServiceServer interface {
	...
	ListFeatureSellRequests(context.Context, *ListFeatureSellRequestsRequest) (*SellRequestsResponse, error)
...
func (UnimplementedFeatureMarketplaceServiceServer) ListFeatureSellRequests(context.Context, *ListFeatureSellRequestsRequest) (*SellRequestsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListFeatureSellRequests not implemented")
}
...
func _FeatureMarketplaceService_ListFeatureSellRequests_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListFeatureSellRequestsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FeatureMarketplaceServiceServer).ListFeatureSellRequests(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FeatureMarketplaceService_ListFeatureSellRequests_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FeatureMarketplaceServiceServer).ListFeatureSellRequests(ctx, req.(*ListFeatureSellRequestsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FeatureMarketplaceService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListFeatureSellRequests",
			Handler:    _FeatureMarketplaceService_ListFeatureSellRequests_Handler,
		},
		{
...
const (
	...
	BuildingService_UpdateBuildingInformation_FullMethodName = "/features.BuildingService/UpdateBuildingInformation"
...
type BuildingServiceClient interface {
	...
	UpdateBuildingInformation(ctx context.Context, in *UpdateBuildingInformationRequest, opts ...grpc.CallOption) (*UpdateBuildingInformationResponse, error)
...
func (c *buildingServiceClient) UpdateBuildingInformation(ctx context.Context, in *UpdateBuildingInformationRequest, opts ...grpc.CallOption) (*UpdateBuildingInformationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateBuildingInformationResponse)
	err := c.cc.Invoke(ctx, BuildingService_UpdateBuildingInformation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BuildingServiceServer interface {
	...
	UpdateBuildingInformation(context.Context, *UpdateBuildingInformationRequest) (*UpdateBuildingInformationResponse, error)
...
func (UnimplementedBuildingServiceServer) UpdateBuildingInformation(context.Context, *UpdateBuildingInformationRequest) (*UpdateBuildingInformationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateBuildingInformation not implemented")
}
...
func _BuildingService_UpdateBuildingInformation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateBuildingInformationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BuildingServiceServer).UpdateBuildingInformation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BuildingService_UpdateBuildingInformation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BuildingServiceServer).UpdateBuildingInformation(ctx, req.(*UpdateBuildingInformationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BuildingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateBuildingInformation",
			Handler:    _BuildingService_UpdateBuildingInformation_Handler,
		},
		{
...
const (
	CitizenFeaturesService_GetCitizenFeatureSummary_FullMethodName = "/features.CitizenFeaturesService/GetCitizenFeatureSummary"
	CitizenFeaturesService_GetCitizenFeatureChart_FullMethodName   = "/features.CitizenFeaturesService/GetCitizenFeatureChart"
	CitizenFeaturesService_ListCitizenFeatures_FullMethodName      = "/features.CitizenFeaturesService/ListCitizenFeatures"
)

// CitizenFeaturesServiceClient is the client API for CitizenFeaturesService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
//
// CitizenFeaturesService handles public citizen feature assets (no auth; privacy applied by gateway)
type CitizenFeaturesServiceClient interface {
	GetCitizenFeatureSummary(ctx context.Context, in *GetCitizenFeatureSummaryRequest, opts ...grpc.CallOption) (*GetCitizenFeatureSummaryResponse, error)
	GetCitizenFeatureChart(ctx context.Context, in *GetCitizenFeatureChartRequest, opts ...grpc.CallOption) (*GetCitizenFeatureChartResponse, error)
	ListCitizenFeatures(ctx context.Context, in *ListCitizenFeaturesRequest, opts ...grpc.CallOption) (*ListCitizenFeaturesResponse, error)
}

type citizenFeaturesServiceClient struct {
	cc grpc.ClientConnInterface
}

func NewCitizenFeaturesServiceClient(cc grpc.ClientConnInterface) CitizenFeaturesServiceClient {
	return &citizenFeaturesServiceClient{cc}
}

func (c *citizenFeaturesServiceClient) GetCitizenFeatureSummary(ctx context.Context, in *GetCitizenFeatureSummaryRequest, opts ...grpc.CallOption) (*GetCitizenFeatureSummaryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetCitizenFeatureSummaryResponse)
	err := c.cc.Invoke(ctx, CitizenFeaturesService_GetCitizenFeatureSummary_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *citizenFeaturesServiceClient) GetCitizenFeatureChart(ctx context.Context, in *GetCitizenFeatureChartRequest, opts ...grpc.CallOption) (*GetCitizenFeatureChartResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetCitizenFeatureChartResponse)
	err := c.cc.Invoke(ctx, CitizenFeaturesService_GetCitizenFeatureChart_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *citizenFeaturesServiceClient) ListCitizenFeatures(ctx context.Context, in *ListCitizenFeaturesRequest, opts ...grpc.CallOption) (*ListCitizenFeaturesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListCitizenFeaturesResponse)
	err := c.cc.Invoke(ctx, CitizenFeaturesService_ListCitizenFeatures_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// CitizenFeaturesServiceServer is the server API for CitizenFeaturesService service.
// All implementations must embed UnimplementedCitizenFeaturesServiceServer
// for forward compatibility.
//
// CitizenFeaturesService handles public citizen feature assets (no auth; privacy applied by gateway)
type CitizenFeaturesServiceServer interface {
	GetCitizenFeatureSummary(context.Context, *GetCitizenFeatureSummaryRequest) (*GetCitizenFeatureSummaryResponse, error)
	GetCitizenFeatureChart(context.Context, *GetCitizenFeatureChartRequest) (*GetCitizenFeatureChartResponse, error)
	ListCitizenFeatures(context.Context, *ListCitizenFeaturesRequest) (*ListCitizenFeaturesResponse, error)
	mustEmbedUnimplementedCitizenFeaturesServiceServer()
}

// UnimplementedCitizenFeaturesServiceServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
type UnimplementedCitizenFeaturesServiceServer struct{}

func (UnimplementedCitizenFeaturesServiceServer) GetCitizenFeatureSummary(context.Context, *GetCitizenFeatureSummaryRequest) (*GetCitizenFeatureSummaryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCitizenFeatureSummary not implemented")
}
func (UnimplementedCitizenFeaturesServiceServer) GetCitizenFeatureChart(context.Context, *GetCitizenFeatureChartRequest) (*GetCitizenFeatureChartResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCitizenFeatureChart not implemented")
}
func (UnimplementedCitizenFeaturesServiceServer) ListCitizenFeatures(context.Context, *ListCitizenFeaturesRequest) (*ListCitizenFeaturesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListCitizenFeatures not implemented")
}
func (UnimplementedCitizenFeaturesServiceServer) mustEmbedUnimplementedCitizenFeaturesServiceServer() {
}
func (UnimplementedCitizenFeaturesServiceServer) testEmbeddedByValue() {}

// UnsafeCitizenFeaturesServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to CitizenFeaturesServiceServer will
// result in compilation errors.
type UnsafeCitizenFeaturesServiceServer interface {
	mustEmbedUnimplementedCitizenFeaturesServiceServer()
}

func RegisterCitizenFeaturesServiceServer(s grpc.ServiceRegistrar, srv CitizenFeaturesServiceServer) {
	// If the following call panics, it indicates UnimplementedCitizenFeaturesServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
	...
	s.RegisterService(&CitizenFeaturesService_ServiceDesc, srv)
}

func _CitizenFeaturesService_GetCitizenFeatureSummary_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCitizenFeatureSummaryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CitizenFeaturesServiceServer).GetCitizenFeatureSummary(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CitizenFeaturesService_GetCitizenFeatureSummary_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CitizenFeaturesServiceServer).GetCitizenFeatureSummary(ctx, req.(*GetCitizenFeatureSummaryRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _CitizenFeaturesService_GetCitizenFeatureChart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCitizenFeatureChartRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CitizenFeaturesServiceServer).GetCitizenFeatureChart(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CitizenFeaturesService_GetCitizenFeatureChart_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CitizenFeaturesServiceServer).GetCitizenFeatureChart(ctx, req.(*GetCitizenFeatureChartRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _CitizenFeaturesService_ListCitizenFeatures_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListCitizenFeaturesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CitizenFeaturesServiceServer).ListCitizenFeatures(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CitizenFeaturesService_ListCitizenFeatures_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CitizenFeaturesServiceServer).ListCitizenFeatures(ctx, req.(*ListCitizenFeaturesRequest))
	}
	return interceptor(ctx, in, info, handler)
}

// CitizenFeaturesService_ServiceDesc is the grpc.ServiceDesc for CitizenFeaturesService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var CitizenFeaturesService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "features.CitizenFeaturesService",
	HandlerType: (*CitizenFeaturesServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetCitizenFeatureSummary",
			Handler:    _CitizenFeaturesService_GetCitizenFeatureSummary_Handler,
		},
		{
			MethodName: "GetCitizenFeatureChart",
			Handler:    _CitizenFeaturesService_GetCitizenFeatureChart_Handler,
		},
		{
			MethodName: "ListCitizenFeatures",
			Handler:    _CitizenFeaturesService_ListCitizenFeatures_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "features.proto",
...
func (UnimplementedCitizenBuildingsServiceServer) GetCitizenBuildingSummary(context.Context, *GetCitizenBuildingSummaryRequest) (*GetCitizenBuildingSummaryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCitizenBuildingSummary not implemented")
}
func (UnimplementedCitizenBuildingsServiceServer) GetCitizenBuildingChart(context.Context, *GetCitizenBuildingChartRequest) (*GetCitizenBuildingChartResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCitizenBuildingChart not implemented")
}
func (UnimplementedCitizenBuildingsServiceServer) ListCitizenBuildings(context.Context, *ListCitizenBuildingsRequest) (*ListCitizenBuildingsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListCitizenBuildings not implemented")
}
...
func RegisterCitizenBuildingsServiceServer(s grpc.ServiceRegistrar, srv CitizenBuildingsServiceServer) {
	// If the following call panics, it indicates UnimplementedCitizenBuildingsServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func (UnimplementedIsicCodeServiceServer) ListIsicCodes(context.Context, *ListIsicCodesRequest) (*ListIsicCodesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListIsicCodes not implemented")
}
...
func RegisterIsicCodeServiceServer(s grpc.ServiceRegistrar, srv IsicCodeServiceServer) {
	// If the following call panics, it indicates UnimplementedIsicCodeServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
